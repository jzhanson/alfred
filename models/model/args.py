...
parser.add_argument('--policy-model-superpixel-context', type=str, default=None, help='whether to include superpixel context vector as input to policy model, and mode (\'hidden\' or \'scene\')')
