...
class InteractionDataset(Dataset):
    ...
    def __init__(self, dataset_path, max_trajectory_length=None,
        ...
        if self.max_trajectory_length is None: # Different length trajectories
            self.num_frames = 0
            for trajectory_directory_name in self.trajectory_directories:
                pass
        else:
    ...
    def __getitem__(self, idx):
        ...
        for index in indexes:
            if self.max_trajectory_length is None:
                ...
                frame_extension = '.png' if self.high_res_images else '.jpg'
                ...
                raw_target = torch.tensor(info['object_counts_' +
                    self.target_type][frame_index])
